...
const SearchArea = () => {
  ...
  return (
    <div
      className={
        "mt-16  items-center lg:items-center lg:mt-28 p-3 lg:h-24  bg-green_dark lg:px-40 px-2 flex flex-col justify-between gap-5"
      }
    >
      {/*"mt-16  items-center lg:items-center lg:mt-28 p-3 lg:h-24  bg-green_dark lg:px-40 px-2 flex flex-col lg:flex-row lg:items-center justify-between gap-5" */}
